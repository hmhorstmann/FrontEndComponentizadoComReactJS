...
const Profile = () => {
    ...
    return (
        <S.Container>
            ...
            <a href={`https://bulbapedia.bulbagarden.net/wiki/${pokeState.pokemon.name}_(Pok%C3%A9mon)`} target="_blank" rel="noreferrer"><S.ContainerImage src={pokeState.pokemon.sprites.other.dreamWorld.frontDefault} alt="Avatar Poke" /></a>
